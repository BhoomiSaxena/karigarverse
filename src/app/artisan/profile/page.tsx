          ...
          >
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div>
                ...
                <p className="text-gray-600 mt-2">Manage your profile and shop information</p>
              </div>
              {!isEditing ? (
                <Button 
                        ...
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
                            <div className="flex items-center gap-2">
                              ...
                              <span>Joined {new Date(artisan.joinDate).toLocaleDateString()}</span>
                            </div>
                            <div className="flex items-center gap-2">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <span>₹{artisan.totalEarnings.toLocaleString()} Earned</span>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <motion.div variants={itemVariants}>
                  <Card className="border-2 border-black rounded-none">
                    <CardHeader>
                      ...
                      <CardDescription>Manage your shop details that customers will see</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div>
                      ...
                      <div>
                        ...
                        <div className="mt-2 border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                          ...
                          <p className="text-gray-600 mb-2">Upload your shop logo or banner</p>
                          <Button 
                            variant="outline" 
                            size="sm" 
                            className="border-2 border-black rounded-none"
                ...
                <motion.div variants={itemVariants}>
                  <Card className="border-2 border-black rounded-none">
                    <CardHeader>
                      ...
                      <CardDescription>Overview of your shop's performance metrics</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="text-center p-4 border border-gray-200 rounded-lg">
                          ...
                          <div className="text-2xl font-bold">{artisan.totalOrders}</div>
                          <div className="text-sm text-gray-600">Total Orders</div>
                        </div>
                        <div className="text-center p-4 border border-gray-200 rounded-lg">
                          <DollarSign className="h-8 w-8 text-green-500 mx-auto mb-2" />
                          <div className="text-2xl font-bold">₹{artisan.totalEarnings.toLocaleString()}</div>
                      ...
                      <div className="flex items-center justify-between p-4 bg-green-50 border border-green-200 rounded-lg">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-green-600">Your artisan account has been verified</p>
                          </div>
                        </div>
                        <Badge className="bg-green-100 text-green-700 border-green-300">
                          Verified
                    ...
                    <CardContent className="space-y-4">
                      <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-medium text-yellow-700">Bank Details Required</p>
                            <p className="text-sm text-yellow-600">Please add your bank details to receive payments</p>
                          </div>
                        </div>
                      </div>
