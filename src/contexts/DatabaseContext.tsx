...
interface DatabaseContextType {
  ...
  createArtisanProfile: (data: Omit<Database['public']['Tables']['artisan_profiles']['Insert'], 'user_id'>) => Promise<void>
}
...
export function DatabaseProvider({ children }: { children: React.ReactNode }) {
  ...
  const createArtisanProfile = async (data: Omit<Database['public']['Tables']['artisan_profiles']['Insert'], 'user_id'>) => {
